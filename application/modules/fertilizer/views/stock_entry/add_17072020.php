...
?>     
				...
				<h4>Stock Details</h4>
					...
					<div class="col-sm-3">
					<input type="text"  style="width:180px" id=ro_no name="ro_no" class="form-control"  />
					</div>

					<label for="ro_dt" class="col-sm-1 col-form-label">Ro Date:</label>
					<div class="col-sm-3">
					<input type="date" style="width:150px" id=ro_dt name="ro_dt" class="form-control"  />
					</div>

					<label for="due_dt" class="col-sm-1 col-form-label">Due Date:</label>
					<div class="col-sm-3">
					<input type="date" style="width:150px" id=due_dt name="due_dt" class="form-control"  />
					</div>
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						...
						<input type="text" style="width:180px" id=qty name="qty" class="form-control"  />

					</div>
					<label for="no_of_bags" class="col-sm-1 col-form-label">No Of Bags/Bucket:</label>
					<div class="col-sm-3">

					<input type="text" style="width:150px" id=no_of_bags name="no_of_bags" class="form-control"  />
					</div> 
					<label for="govt_sale_rt" class="col-sm-1 col-form-label">Govt Sale Rate:</label>
					<div class="col-sm-3">
				...
				<div class="form-group row">
					...
					<label for="cgst" class="col-sm-1 col-form-label">CGST:</label>
						...
						<input type="text" style="width:150px" id=cgst name="cgst" class="form-control" readonly  />
						</div> 
	
						<label for="sgst" class="col-sm-1 col-form-label">SGST:</label>
						<div class="col-sm-3">
	
							<input type="text" style="width:150px" id=sgst name="sgst" class="form-control" readonly  />
