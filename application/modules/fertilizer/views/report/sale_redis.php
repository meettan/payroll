...
?>        
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" 
                id="form"
                action="<?php echo site_url("fertilizer/sale_reportdis");?>" >
               ...
               <!--  <div class="form-group row">
                    ...
                    <label for="from_date" class="col-sm-2 col-form-label"> Date:</label>
            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Sale Report of <?php echo get_district_name($this->input->post('branch_id'));?></h4>
                    ...
                    <table style="width: 100%;" id="example" >
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                     <td><?php echo $i++; ?></td>
                                     <td><?php echo date("d/m/Y",strtotime($sale->do_dt)); ?></td>
                                     <td><?php echo $sale->COMP_NAME; ?></td>
                                     <td><?php echo $sale->PROD_DESC; ?></td>
