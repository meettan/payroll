...
?>        
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" 
                id="form"
                action="<?php echo site_url("fertilizer/cr_reportdis");?>" >
            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Credit Report of <?php echo get_district_name($this->input->post('branch_id'));?></h4>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                     ...
                                     <td><?php echo $sale->do_no; ?></td>
                                     <td><?php echo date("d/m/Y",strtotime($sale->do_dt)); ?></td>
                                     <td><?php echo $sale->tot_cr_amt; ?></td>
