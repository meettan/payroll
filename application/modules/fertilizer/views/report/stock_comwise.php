...
?>        
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" 
                id="form"
                action="<?php echo site_url("fertilizer/stock_reportcompanywise");?>" >

                <div class="form-header">
                
                    <h4>Stock Report CompanyWise</h4>
            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Stock Report Company Wise</h4>
                               ...
                               if(isset($companies)) {
                                  ...
                                  foreach($companies as $companie) {
                                              ...
                                              foreach($stocks as $stock) {
                                                ...
                                                if($companie->COMP_ID ==$stock->COMPANY){


                            ?>

                                <tr>
                                     <td colspan=""><?php echo $companie->COMP_NAME; ?></td>
