...
?>        
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" 
                id="form"
                action="<?php echo site_url("fertilizer/society_report");?>" >

                <div class="form-header">
                
                    <h4>Society Report</h4>
            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Society List of <?php echo get_district_name($this->input->post('branch_id'));?></h4>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                     ...
                                     <td><?php echo $soc->inchargename; ?></td>
                                      <td><?php echo $soc->ph_no; ?></td>
                                </tr>
