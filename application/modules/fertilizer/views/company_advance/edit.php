<div class="wraper">      
	...
	<div class="col-md-6 container form-wraper">
		...
		<form method="POST" id="product" action="<?php echo site_url("adv/company_editadv") ?>" >

			<div class="form-header">
			
				<h4>Edit Company Advance</h4>
            ...
            <div class="form-group row">
				<label for="society" class="col-sm-2 col-form-label">Company:</label>
				<div class="col-sm-4">
					...
					<select name="company" class="form-control required" id="company" required>
                        ...
                        <?php
                            ...
                            foreach($compDtls as $val){

                        ?>

                        <option value="<?php echo $val->comp_id;?>"<?php echo($advDtls->comp_id==$val->comp_id)?'selected':'';?>><?php echo $val->comp_name;?></option>
