			...
			<form method="POST" action="<?php echo site_url("finance/f_new_cash_voucher")?>" onsubmit="return valid_data()">
				...
				<div class="form-group row">
					...
					<div class="col-sm-7">
						...
						<input type = date  name = "voucher_dt" class="transparent_tag" value="<?php echo $_SESSION['sys_date'];?>" 
								readonly />
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<select name = "voucher_type" id = "v_type" style="width: 100%;" onchange="set_dr_cr()" class="form-control">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<input type="text" name="acc_hd" class="transparent_tag" value="Cash In Hand" style="width: 85px; display:inline;" readonly/>
