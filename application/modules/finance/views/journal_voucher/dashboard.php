<F12><div class="wraper">      
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
                <a href="<?php echo site_url("finance/addTrfVoucher");?>" class="btn btn-primary" style="width: 100px;">Add</a>
	...
	$(document).ready( function (){
        ...
        $('.delete').click(function () {
            ...
            if(result) {
                ...
                window.location = "<?php echo site_url('finance/delTrfVoucher?voucher_id="+id+"&voucher_date="+date+"');?>";
